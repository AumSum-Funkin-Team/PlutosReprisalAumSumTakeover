...
class ModsMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		noModsTxt = new FlxText(0, 0, FlxG.width, "how dare you delete the mod folder", 48);
		if(FlxG.random.bool(0.8)) noModsTxt.text += '\nwhy delete the pr aumsum takeover bro'; //meanie
